...
public class DetailsController {
	...
	public List<Details> getAllDetails(){
	 ...
	 @PutMapping(value="/editdetails2/{detailsid}")
		public String editMatchDetails2(@PathVariable(name="detailsid")int detailsid,
				@RequestBody Details details) {
			String response = "";
		      if( detailsService.editMatchdetails2(detailsid, details) )
		      {
		            response =  "{'status': 'success'}";
		      }
		      else {
