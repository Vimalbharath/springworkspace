...
public class AspectConfig {
	...
	@Before(value= "execution(* com.htc.music.service.*.*(..))")
	...
	@After(value= "execution(* com.htc.music.service.*.*(..))")
	...
	@AfterReturning(value= "execution(* com.htc.music.service.*.*(..))", returning = "retVal")
	public void afterReturning(JoinPoint joinPoint, Object retVal)
	{
		log.info("After Returning {}"+retVal.toString());
	}
	
	@Around(value= "execution(* com.htc.music.service.*.*(..))")
